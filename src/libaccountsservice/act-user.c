 ...
 * @error: a #GError
 *
 * Lists the groups of a user.  This operation might query remote
 * databases and thus be slow.
 *
 * Returns: (transfer full) A %NULL-terminated array of ActGroup
 * objects.  Free it by unreffing all ActGroup objects and the calling
 * g_free on the array.  Returns %NULL in case of error.
 */
ActGroup **
